...
class MockProteinReference(object):
    ...
    def __init__(self, tempdir: str):
        ...
        for cf_set, cfile, ffile in zip(
            ...
            np.save(join(tempdir, cfile), cf_set[0])
            np.save(join(tempdir, ffile), cf_set[1])
